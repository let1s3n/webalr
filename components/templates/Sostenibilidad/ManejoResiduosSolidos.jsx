    ...
    <>
      ...
      <Container fluid className="manejoResiduosPage g-0">
        ...
        <Container className="g-0 py-4 px-3">
          ...
          <p className="text-center">{t('sustainability_solid_waste_management_text_p1', { ns: 'general' })}</p>
        ...
        <Container fluid className="g-0 mt-4 mb-10">
          ...
          <Image className="d-block w-100" src={`${process.env.NEXT_CDN}images/residuosSolidos.jpg`} />
