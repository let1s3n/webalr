        ...
        <Container className="g-0 py-4 px-3">
          <div className="mb-4 text-center">
            <h1 className="fs-2 text-center text-primary">
              {t("dictionary.health_and_safety", { ns: "general" })}{" "}
              <span className="text-secondary">
                {t("dictionary.occupational", { ns: "general" })}
              </span>
            </h1>
            <Breadcrumb>
              ...
              <Breadcrumb.Item
                href="/sostenibilidad/seguridad-y-salud-ocupacional"
                active
              >
                {t("sections.occupational_health_and_safety", {
                  ns: "general",
                })}
              </Breadcrumb.Item>
            </Breadcrumb>
          ...
          <p className="text-center">
            {t("sustainability_ssoma_text_p1", { ns: "general" })}
          </p>
          ...
          >
            <SwiperSlide>
              <Image
                ...
                src={`${process.env.NEXT_CDN}images/ssoma.jpg`}
