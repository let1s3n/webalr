    ...
    <>
      ...
      <>
        <section className="hero-section">
          <div className="h-100">
            ...
            <h1 className="hero-text position-absolute text-white w-100 trocchiRegular px-3">
              ...
              <p className="mb-2">
                <span className={locale === "en" ? "text-secondary" : ""}>
        ...
        <section className="quienes-somos pt-6 pt-custom1-9">
          <Container fluid="md">
            <p className="text-primary mb-3 mb-custom1-5 text-center fs-5 fs-lg-4 fs-xl-3">
          ...
          <Container fluid className="g-0 my-3 my-custom1-7 text-center">
            <div
              className="d-flex justify-content-center gap-2 gap-lg-3 division-title"
              style={{ padding: 32 + "px", borderRadius: "0px 20px 20px 0px" }}
            >
              <p className="m-0  text-primary fs-5 fs-custom1-2">
                {t("our", { ns: "general" })}{" "}
                <span className="text-secondary">
                  {t("our_mission_vision_values_title", { ns: "general" })}
                </span>
              </p>
            </div>
          </Container>
          <div className="py-custom1-4 px-xl-4">
            <CardGroup
              className="justify-content-xl-center align-items-center flex-column flex-xl-row"
              style={{ rowGap: "1.5rem" }}
            >
              <Card className="text-white mx-auto mx-sm-0">
                <Card.Img
                  src={`${process.env.NEXT_CDN}images/mision.jpg`}
                  alt="Misión de ALR"
                />
              ...
              <Card className="text-white mx-auto mx-sm-0">
                <Card.Img
                  src={`${process.env.NEXT_CDN}images/vision.jpg`}
                  alt="Visión de ALR"
                />
                <Card.ImgOverlay className="d-flex align-items-center justify-content-center">
        ...
        <section className="novedades mb-5">
          <Container
            fluid
            className="g-0 mb-3 mb-custom1-7 d-flex justify-content-center pt-custom1-5"
          >
            <div
              className="d-flex gap-3 justify-content-center division-title"
              style={{ padding: 32 + "px", borderRadius: "20px 0px 0px 20px" }}
            >
              <p className="m-0  text-primary fs-5 fs-custom1-2">
                {t("news", { ns: "general" })}{" "}
                <span className="text-secondary">
                  {t("featured", { ns: "general" })}
                </span>
              </p>
            </div>
          </Container>
        ...
        <section className="mb-5">
          <Container fluid className="g-0">
            <Row
              className="g-0"
              style={{ background: "#f5f5f5", height: "250px" }}
            >
              <Col
                lg={6}
                className="border-end border-white d-flex justify-content-center align-items-center text-center"
              >
                <div className="home__links-section">
                  <p className="item-text">
                    {t("dictionary.policies", { ns: "general" })}
                  </p>
                  <div className="item-button">
                    <Link href="/politicas">
                      <p className="mb-0">
                        {t("buttons.policies", { ns: "general" })}
                      </p>
                    </Link>
                  </div>
                </div>
              ...
              >
                <div className="home__links-section">
                  <p className="item-text">
                    {t("dictionary.press", { ns: "general" })}
                  </p>
                  <div className="item-button">
                    <Link href="/politicas">
                      <p className="mb-0">
                        {t("buttons.press_note", { ns: "general" })}
                      </p>
                    </Link>
                  </div>
                </div>
        ...
        <section className="home__contact-us position-relative">
          ...
          <div className="button-contact position-absolute top-50 start-50 translate-middle">
            <Link href="/contacto">
              <p className="mb-0">
                {t("buttons.contact_us", { ns: "general" })}
              </p>
            </Link>
          </div>
        </section>
