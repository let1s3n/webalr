...
import { Row, Col, Container, Image, Breadcrumb, Card } from "react-bootstrap";
    ...
    <>
      ...
      <Container fluid className="prensaPage g-0">
        ...
        <Container className="py-4 px-3 g-0 text-center">
          <h1 className="fs-2 text-primary text-uppercase">
          ...
          <Breadcrumb>
            ...
            <Breadcrumb.Item href="/prensa" active>
              {t("sections.press", { ns: "general" })}
            </Breadcrumb.Item>
          </Breadcrumb>
        </Container>
            ...
            {Array.from({ length: 9 }).map((_, idx) => (
              <Col key={idx}>
                <Card>
                  ...
                  <Card.Body>
                    <Card.Title>
                      {t("dictionary.cardTitle", { ns: "general" })}
                    </Card.Title>
                    <Card.Text>
