    ...
    <>
      ...
      <div className="perfilesPage">
        ...
        <section className="directors-management__content mx-auto perfiles d-flex flex-column justify-content-center align-items-center mt-4 p-3 py-xl-5">
          <h1 className="mb-5 mt-5 mt-xl-0 mb-custom1-8 fw-bold text-center futuraBold text-primary">
          ...
          <Container fluid className="g-0">
            <div className='bg-primary text-white mx-lg-5 text-center px-3 px-lg-5 py-4 py-xl-5 mb-5'>
              <div>
                <h2 className='fw-bold'>{t('jose_carneiro_title1', { ns: 'general' })}</h2>
            ...
            <div className='px-md-3 px-lg-5'>
              <Row className='mb-3'>
                <Col xs={12} lg={6}>
                  <div className='p-5 directors-management__card mb-4 mb-xl-0'>
                    <div>
                      <h3 className='fw-bold text-primary'>{t('jhon_quispe_title1', { ns: 'general' })}</h3>
                ...
                <Col xs={12} lg={6}>
                  <div className='p-5 directors-management__card mb-4 mb-xl-0'>
                    <div>
                      <h3 className='fw-bold text-primary'>{t('hector_gomez_title1', { ns: 'general' })}</h3>
                      <div className='border border-secondary w-25 mb-3'></div>
              ...
              <Row className='mb-3'>
                <Col xs={12} lg={6}>
                  <div className='p-5 directors-management__card mb-4 mb-xl-0'>
                    <div>
                      <h3 className='fw-bold text-primary'>{t('andre_carneiro_title1', { ns: 'general' })}</h3>
                      <div className='border border-secondary w-25 mb-3'></div>
                ...
                <Col xs={12} lg={6}>
                  <div className='p-5 directors-management__card mb-4 mb-xl-0'>
                    <div>
                      <h3 className='fw-bold text-primary'>{t('rolando_algarate_title1', { ns: 'general' })}</h3>
                      <div className='border border-secondary w-25 mb-3'></div>
              ...
              <Row className='mb-3'>
                <Col xs={12} lg={6}>
                  <div className='p-5 directors-management__card mb-4 mb-xl-0'>
                    <div>
                      <h3 className='fw-bold text-primary'>{t('oliver_huaman_title1', { ns: 'general' })}</h3>
                      <div className='border border-secondary w-25 mb-3'></div>
                ...
                <Col xs={12} lg={6}>
                  <div className='p-5 directors-management__card mb-4 mb-xl-0'>
                    <div>
                      <h3 className='fw-bold text-primary'>{t('darwin_delgado_title1', { ns: 'general' })}</h3>
                      <div className='border border-secondary w-25 mb-3'></div>
              ...
              <Row className='mb-3'>
                <Col xs={12} lg={6}>
                  <div className='p-5 directors-management__card mb-4 mb-xl-0'>
                    <div>
                      <h3 className='fw-bold text-primary'>{t('william_medrano_title1', { ns: 'general' })}</h3>
                      <div className='border border-secondary w-25 mb-3'></div>
                ...
                <Col xs={12} lg={6}>
                  <div className='p-5 directors-management__card mb-4 mb-xl-0'>
                    <div>
                      <h3 className='fw-bold text-primary'>{t('rafael_farfan_title1', { ns: 'general' })}</h3>
                      <div className='border border-secondary w-25 mb-3'></div>
