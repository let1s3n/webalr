          ...
          <Container fluid className="g-0">
            <div className='bg-primary text-white mx-lg-5 text-center px-3 px-lg-5 py-4 py-xl-5 mb-5'>
              ...
              <div className="pt-4 px-3 px-md-5 px-xl-6">
                ...
                {/* <p>{t('jose_carneiro_text2', { ns: 'general' })}</p> */}
              </div>
            </div>
            ...
            <div className='px-md-3 px-lg-5'>
              ...
              <Row className='mb-3'>
                ...
                <Col xs={12} lg={6}>
                  <div className='p-5 directors-management__card bg-primary text-white mb-4 mb-xl-0'>
                    <div>
                      <h3>{t('jose_carneiro_escalante_title1', { ns: 'general' })}</h3>
                      <div className='border border-secondary w-25 mb-3'></div>
                      <h6>{t('jose_carneiro_escalante_title2', { ns: 'general' })}</h6>
                    </div>
                    <div className="pt-3">
                      <p className='mb-0'>{t('jose_carneiro_escalante_text', { ns: 'general' })}</p>
                    </div>
                  </div>
                </Col>
              ...
              <Row className='mb-3'>
                ...
                <Col xs={12} lg={6}>
                  <div className='p-5 directors-management__card bg-primary text-white mb-4 mb-xl-0'>
                    <div>
                      <h3>{t('alicia_sucari_title1', { ns: 'general' })}</h3>
                      <div className='border border-secondary w-25 mb-3'></div>
                      <h6>{t('alicia_sucari_title2', { ns: 'general' })}</h6>
                    </div>
                    <div className="pt-3">
                      <p className='mb-0'>{t('alicia_sucari_text', { ns: 'general' })}</p>
                    </div>
                  </div>
                </Col>
              ...
              <Row className='mb-3'>
                ...
                <Col xs={12} lg={6}>
                  <div className='p-5 directors-management__card bg-primary text-white mb-4 mb-xl-0'>
                    <div>
                      <h3>{t('telmo_sagastegui_title1', { ns: 'general' })}</h3>
                      <div className='border border-secondary w-25 mb-3'></div>
                      <h6>{t('telmo_sagastegui_title2', { ns: 'general' })}</h6>
                    </div>
                    <div className="pt-3">
                      <p className='mb-0'>{t('telmo_sagastegui_text', { ns: 'general' })}</p>
                    </div>
                  </div>
                </Col>
